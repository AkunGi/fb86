...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (SymbianOS/9.3; Series60/3.2 NokiaE52-1/052.003; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/525 (KHTML, like Gecko) Version/3.0 BrowserNG/7.2.6.2 3gpp-gba"
	#ua = f"Mozilla/5.0 (Linux; Android {str(rr(5,12))}; Redmi Note {str(rr(2,12))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/ {str(rr(75,150))}.0.{str(rr(5111,5999))}.{str(rr(73,99))} Mobile Safari/537.36"
	#ua = f"Mozilla/5.0 (Linux; Android {str(rr(5,12))}; ASUS_Z01QD) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/ {str(rr(75,150))}.0.{str(rr(5111,5999))}.{str(rr(73,99))} Mobile Safari/537.36"
...
if __name__=="__main__":
	...
	Menu().menu()
#Gunakan Facebook dalam mode dasar dengan Axis
Menu().menu()
#Gunakan Facebook dalam mode dasar dengan Axis
Menu().menu()
#Gunakan Facebook dalam mode dasar dengan Axis
